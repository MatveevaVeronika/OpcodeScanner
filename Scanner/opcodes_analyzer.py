        ...
        for tv in temporary_vars: 
            ...
            if tv.var_score == opcodes.VarScore.DANGEROUS:
                ...
                if function in V.dangerous_functions:
                    print("\nDANGEROUS: Temporary variable", tv.ID, " used in a dangerous function", function, "without a protective function \nin file:", EP.filename.strip(),"\nin function:", EP.function_name)
                else:
                    print("\nDANGEROUS: Temporary variable", tv.ID, " used in a dangerous function without a protective function \nin file:", EP.filename.strip(),"\nin function:", EP.function_name)
        for cv in compiled_vars: 
            ...
            if cv.var_score == opcodes.VarScore.UNSECURE:
                print("\nUNSECURE: Compiled variable", cv.ID, "=" , cv.name, " used without a protective function \nin file:", EP.filename.strip(),"\nin function:", EP.function_name)
            if cv.var_score == opcodes.VarScore.DANGEROUS:
                function = o.operation
                if function == "DO_FCALL":
                    function = o.operands[0]
                if function in V.dangerous_functions:
                    print("\nDANGEROUS: Compiled variable", cv.ID, "=", cv.name, "used in a dangerous function", function, "without a protective function \nin file:", EP.filename.strip(),"\nin function:", EP.function_name)
                else:
                    print("\nDANGEROUS: Compiled variable", cv.ID, "=", cv.name, "used in a dangerous function without a protective function \nin file:", EP.filename.strip(),"\nin function:", EP.function_name)
        for rv in returned_vars: 
            ...
            if rv.var_score == VarScore.UNSECURE:
            ...
            if rv.var_score == opcodes.VarScore.DANGEROUS:
                ...
                if function == "DO_FCALL":
                    function = o.operands[0]
                if function in V.dangerous_functions:
                    print("\nDANGEROUS: Returned variable", rv.ID, "used in a dangerous function", function, "without a protective function \nin file:", EP.filename.strip(),"\nin function:", EP.function_name)
